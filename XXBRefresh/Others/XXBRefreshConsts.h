 ...
 *  松开刷新
 */
UIKIT_EXTERN NSString *const XXBHeaderRefreshDropEnd;
/**
 *  松开加载更多
 */
UIKIT_EXTERN NSString *const XXBFooterRefreshDropEnd;
/**
 *  正在刷新
 */
UIKIT_EXTERN NSString *const XXBHeaderRefreshing;
/**
 *  正在刷新
 */
UIKIT_EXTERN NSString *const XXBFooterRefreshing;
